...
export function PortfolioExperience() {
  ...
  else spread = <section className="closing-scene" aria-label="Thank you. Click to close the binder." onClick={() => { setOpened(false); setPage(0); }}><div className="closing-cover"><h2>Thank you</h2></div></section>;
